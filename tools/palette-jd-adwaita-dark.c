...
{
    add_header("jd-adwaita-dark");
    add_backgrounds("#272C2E","#232729","#888");   // darker

    add_color("#232729"	,"darker_anthracite=#232729");
    add_color("#272C2E"	,"dark_anthracite=#272C2E");
    add_color("#2C3234"	,"anthracite=#2C3234");
    ...
    add_color("#8eb33b"	,"green=#8eb33b");
    add_color("#086aa7"	,"dark_blue=#086aa7");
    add_color("#729fcf"	,"blue=#729fcf");
    add_color("#2597a6"	,"cyan=#2597a6");
    add_color("#77dfd8"	,"light_cyan=#77dfd8");
    add_color("#cf0912"	,"red=#cf0912");
    add_color("#EAEAEA"	,"almost_white=#EAEAEA");
    add_color("#d0d0d0"	,"grey=#d0d0d0");
    add_color("#888"	,"mid_grey=#888");
    add_color("#666666"	,"dark_grey=#666666");
